...
outputs:
- id: output
  outputBinding: {glob: $(inputs.output_filename + '_corrected_quantile.isoforms.results')}
  type: File
package: file:///home/bhaas/Winterfell_SMC_RNA_DREAM2016/RSEM/cwl/tools/rsem.cwl
requirements:
- {class: InlineJavascriptRequirement}
- {class: DockerRequirement, dockerPull: 'winterfelldream2016/expressionpipe:beta_gc_bias_correct'}
